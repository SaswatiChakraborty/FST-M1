...
public class Activity4 {
    ...
    public void todoListTest() {
        ...
        driver.findElement(AppiumBy
                .xpath("//android.webkit.WebView[@text=\"Todo List\"]/android.view.View/android.view.View/android.view.View[1]/android.widget.EditText"))
        ...
        List<WebElement> taskAfterClearing = driver.findElements(AppiumBy
                .xpath("//android.webkit.WebView[@text=\"Todo List\"]/android.view.View/android.view.View/android.view.View[2]"));
        //Assertion
